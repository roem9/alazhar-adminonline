        ...
        public function ajax_list($konfirm){
            ...
            foreach ($list as $peserta) {
                ...
                if($konfirm == 1){
                    ...
                    if($peserta->data_login == 1) $row[] = '<center><a target="_blank" href="javascript:void(0)" data-id="'.$peserta->id_user.'|'.$peserta->nama.'|https://api.whatsapp.com/send?phone=62'.substr($peserta->no_hp, 1).'&text=%F0%9F%91%8F%20*Selamat%20'.$nama.'%20kamu%20sudah%20terdaftar%20di%20Member%20Area%20Al%20Azhar%20Arabic%20Online.*%0A%0A*Silahkan%20kunjungi%20'.$link_member['value'].'*%0A%0A*Ini%20data%20Login%20kamu%20ya%3A*%0AUsername%20%3A%20'.$peserta->username.'%0APassword%20%3A%20'.date('His', strtotime($peserta->tgl_input)).'%0A%0AJika%20ada%20pertanyaan%20lebih%20lanjut%2C%20harap%20menghubungi%20saya%20langsung%20ya%20%F0%9F%98%8A%0A%0A*-%20Admin%20Al%20Azhar%20Arabic%20Online*" id="dataLogin" class="btn btn-sm btn-success"><i class="fa fa-user-lock"></i></a></center>';
